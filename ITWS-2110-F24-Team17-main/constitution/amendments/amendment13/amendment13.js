$(document).ready(function(){
    ...
    $.ajax({
        ...
        success: function(responseData, status) {
            var analysis1 = responseData.Amendment13.analysis1;
            var analysis2 = responseData.Amendment13.analysis2;
            var description1 = responseData.Amendment13.section1;
            var description2 = responseData.Amendment13.section2;
