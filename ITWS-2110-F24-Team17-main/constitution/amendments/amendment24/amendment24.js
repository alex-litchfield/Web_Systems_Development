$(document).ready(function(){
    ...
    $.ajax({
        ...
        success: function(responseData, status) {
            var analysis1 = responseData.Amendment24.analysis1;
            var analysis2 = responseData.Amendment24.analysis2;
            var description1 = responseData.Amendment24.section1;
            var description2 = responseData.Amendment24.section2;
