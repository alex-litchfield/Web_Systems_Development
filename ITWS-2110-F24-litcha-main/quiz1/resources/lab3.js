function getCurrencyInfo() {
    ...
    fetch('./resources/getConversionData.php')
    ...
    .then(data => {
        ...
        const bottomBox = document.getElementById('conversionBox');
        bottomBox.style.display = 'flex';
        document.getElementById("inputCountryName").innerHTML = "<strong>Country of Origin: </strong>" + data.country_to_convert_from;
        document.getElementById("inputConversion").innerHTML = "<strong>Type(s)Amount: </strong>" + data.amount_to_convert_from;
        document.getElementById("outputCountryName").innerHTML = "<strong>Country to Convert to: </strong>" + country_to_convert_to;
        document.getElementById("outputConversion").innerHTML = "<strong>New Amount: </strong>" + data.amount_to_convert_to;
    })
    .catch(error => {
...
function submitPopupMenuInfo() {
    ...
    //Send and display conversion Data
    const conversionCountryFromInput = document.getElementById('conversionCountryFromInput').value;
    const conversionCountryToInput = document.getElementById('conversionCountryToInput').value;
    const currencyToConvertFromInput = document.getElementById('pokemonHeightInput').value;
    ...
    const currencyToConvertToOutput = convert(conversionCountryFromInput, conversionCountryToInput, currencyToConvertFromInput);
    ...
    .then(data => {
        ...
        fetch('./resources/insertConversionData.php', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
            body: JSON.stringify({
                country_to_convert_from: conversionCountryFromInput || "None",
                country_to_convert_to: conversionCountryToInput || "None",
                amount_to_convert_from: currencyToConvertFromInput || "None",
                amount_to_convert_to: currencyToConvertToOutput || "None",
            }),
        })
        .then(response => response.text())
        .then(result => {
