-- Create the database
CREATE DATABASE quiz1_database;
...
-- Create the currency_conversion table
CREATE TABLE currency_conversion_data (
    id INT AUTO_INCREMENT PRIMARY KEY,
    country_to_convert_from VARCHAR(100),
    country_to_convert_to VARCHAR(100),
    amount_to_convert_from FLOAT,
    amount_to_convert_to FLOAT
);